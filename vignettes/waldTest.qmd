...
format:
  html:
    ...
    mainfont: "Source Serif 4, Georgia, serif"
...
P-values are from $F_{1,54}$ rather than $\chi^2_1$ — slightly more
conservative in small samples.
...
requires an ASReml-R V4 licence and is shown for reference only.
